...
public class EmployeeLogin extends javax.swing.JFrame {
   ...
   private void connect()
    ...
    private void initComponents() {
        ...
        jPanel1.add(jPanel2);
        jPanel2.setBounds(341, 3, 344, 420);

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/addd.jpg"))); // NOI18N
        jLabel5.setText("jLabel5");
        jPanel1.add(jLabel5);
        jLabel5.setBounds(0, 0, 340, 410);

        getContentPane().add(jPanel1);
        jPanel1.setBounds(430, 190, 680, 410);

        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/bg3.jpg"))); // NOI18N
        jLabel7.setText("jLabel7");
        getContentPane().add(jLabel7);
        jLabel7.setBounds(0, 0, 1920, 1110);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            String sql1 = "select email,password from employee where email = '"+uname+"' and password = '"+pass+"'";
